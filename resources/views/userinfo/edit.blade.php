                    ...
                    <form method="POST"  action="{{ url('updating/'.$info['id'])}}" >
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <input id="address" type="address" placeholder="Enter Your Address " class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" value="{{  $info['address'] }}" required>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <input id="ptclNo" type="text" placeholder="Enter PTCL Number ( 051331234567 ) " class="form-control{{ $errors->has('ptclNo') ? ' is-invalid' : '' }}" name="ptclNo" value="{{  $info['ptclNO'] }}"  >
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                    ...
                                    <input id="identity" type="tel" size="15" maxlength="15" placeholder="CNIC NO ( 6110112345678 )" class="form-control{{ $errors->has('identity') ? ' is-invalid' : '' }}" name="identity" value="{{  $info['identity'] }}"  pattern="[0-9]{13}" title=" Please match the CNIC No" >
